...
constexpr const char* TYPE_NAME_VERTEX = "VERTEX";
constexpr const char* TYPE_NAME_INDEX = "INDEX";
constexpr const char* TYPE_NAME_MESH = "MESH";
constexpr const char* TYPE_NAME_MATERIAL = "MATERIAL";
}  // namespace kplge
